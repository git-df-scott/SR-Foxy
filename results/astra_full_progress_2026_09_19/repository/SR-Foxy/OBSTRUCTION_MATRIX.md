...
| Turaev multiplace Seifert form | **HYPOTHESES FAIL** (Thm H(ii) is proved via π₁-surjectivity, i.e. it obstructs homotopy-ribbonness; recovered 2026-09-11, see `ERRATA`) | **HYPOTHESES FAIL** (same) | **APPLIES BUT VANISHES** as a slice obstruction (Thm J); non-ribbon already known | **NOT YET COMPUTED**; cannot exceed homotopy-ribbon level |
